...
import symptom_scope from '../assets/symptom_scope.jpg';
...
export const projectData = [
  ...
  {
    projectImg: symptom_scope,
    alt: 'Symptom Scope website',
    title: 'Symptom Scope',
    description:
      'A health management tool designed to empower users with a structured approach to monitor wellness. By tracking daily symptoms, their severity, and many other metrics, the app helps users identify patterns and potential triggers over time. Symptom Scope generates detailed health reports, enabling more accurate discussions with healthcare providers and supporting timely adjustments to treatment plans. Symptom Scope bridges the gap between daily self-care and professional medical consultations, making health tracking more intuitive and impactful.',
    ...
    listItem5: 'Redux',
    listItem6: '',
    githubLink: 'https://github.com/akinevans/symptom-scope',
    externalLink: 'https://github.com/akinevans/symptom-scope',
  },
];
